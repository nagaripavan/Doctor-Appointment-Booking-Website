  ...
  return (
    <div className='mt-40 mb-5'>
        <div className='grid grid-cols-3 gap-8 mb-8 '>
            {/*------------Left section--------- */}
            <div className='w-1/2 '>
                <img className='mb-5' src={assets.logo1} alt="" />
                <p className='text-sm w-100'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
